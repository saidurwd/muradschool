...
style="font-size: 14pt; font-family: Verdana; color: #000000">
	...
	<div align="center"> 
		...
		<div class="maincontent">
			...
			?>
			<table cellpadding="0" cellspacing="0" border="1" id="maintable" width="1030px">
				<tr>
			...
			<div class="mypagination">
				<?php 
					...
					echo "<a href='_present_suborno_database.php?page=1'>".'< First page'."</a> "; 

					for ($i=1; $i<=$total_pages; $i++) { 
						echo "<a href='_present_suborno_database.php?page=".$i."'>".$i."</a> "; 
					}; 
					echo "<a href='_present_suborno_database.php?page=$total_pages'>".'Last page >'."</a> "; 
				?>
			</div>
		</div>
	</div>
