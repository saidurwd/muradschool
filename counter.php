...
// datebase settings
$counter_host = "jorabarighs.db.8672095.hostedresource.com";
$counter_user = "jorabarighs";
$counter_password = "MuR1@d123";
$counter_database = "jorabarighs";
...
<div style="width:150px;"><br />
   <div style="border:1px solid #000000;padding:2px;width:100%;font-size:80%;font-weight:bold;"><br /> <br />
      <img src="sw/counter.gif" width="16" height="16" border="0" /> Visitor Statistics 
   </div>

<div style="border:1px solid #000000;padding:2px;width:100%;font-size:80%;">
      &raquo; <?php echo $online; ?> Online Now<br />  <br /> 
      &raquo; <?php echo $day_value; ?> Today Visitor <br /><br />
      &raquo; <?php echo $yesterday_value; ?> Yesterday<br />
      &raquo; <?php echo $week_value; ?> Week<br /><br />
      &raquo; <?php echo $month_value; ?> Month<br /><br />
      &raquo; <?php echo $year_value; ?> Year<br /><br />
