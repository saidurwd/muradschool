	...
	<div align="center"> 
		...
		<div class="maincontent">
			...
			<?php 
				...
				$sql = "SELECT * FROM notice_tbl order by n_id DESC LIMIT $start_from, $num_rec_per_page"; 
			...
			<table cellpadding="1" cellspacing="1" border="2" id="maintable" width="960px">
				...
				<tr>
					...
					<td style="text-align:center;width:200px;padding:5px;">
						<a href="backend/upload/<?php echo $row['n_download']; ?>" style="color: green;font-weight:bold;">Download</a>
					</td>
			...
			<div class="mypagination">
				<?php 
					...
					echo "<a href='_notice_view_all.php?page=1'>".'< First page'."</a> "; 

					for ($i=1; $i<=$total_pages; $i++) { 
						echo "<a href='_notice_view_all.php?page=".$i."'>".$i."</a> "; 
					}; 
					echo "<a href='_notice_view_all.php?page=$total_pages'>".'Last page >'."</a> "; 
				?>
			</div>
		</div>
	</div>
