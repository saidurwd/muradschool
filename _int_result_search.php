                        ...
                        <form method="post" action="">
                            ...
                            if (isset($_POST['roll_search'])) {
                                ...
                                if (empty($_POST['roll_search'])) {
                                    ...
                                    $query = mysql_query("SELECT * from result_tbl WHERE res_roll = " . $searchroll . "  AND res_class = '" . $searchclass . "' AND res_year = '" . $searchyear . "' AND status=1 LIMIT 1") or die('could not search');
                                    ...
                                    while ($row = mysql_fetch_array($query)) {
                                        ...
                                        <div id="divToPrint" class="resulttbl">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%" border="1" style="margin-bottom: 15px; border: 3px solid blue;border-collapse: collapse;background:#fff;">
                                                <tbody>					
                                                    <tr>
                                                        <td valign="middle" height="30" align="center" style="font-weight: bold; font-size: 20px; color: #000;">"<?php echo $row['res_ins']; ?>"
                                                        </td>
                                                    </tr>               
                                                    <tr>
