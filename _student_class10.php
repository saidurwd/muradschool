	...
	<div align="center"> 
		...
		<div class="maincontent">
			...
			<?php 
				...
				$sql = "SELECT * FROM std_class10_tbl LIMIT $start_from, $num_rec_per_page"; 
			...
			<div class="mypagination">
				<?php 
					$sql = "SELECT * FROM std_class10_tbl"; 
					$rs_result = mysql_query($sql); 
					$total_records = mysql_num_rows($rs_result);  
					$total_pages = ceil($total_records / $num_rec_per_page); 

					echo "<a href='_student_class10.php?page=1'>".'< First page'."</a> "; 

					for ($i=1; $i<=$total_pages; $i++) { 
						echo "<a href='_student_class10.php?page=".$i."'>".$i."</a> "; 
					}; 
					echo "<a href='_student_class10.php?page=$total_pages'>".'Last page >'."</a> "; 
				?>
			</div>
		</div>
	</div>
