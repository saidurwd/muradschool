		...
		if ($error > 0){
			...
			die("Format is not allowed or file size is too big!");
				...
				if(($file_ext!='.png')&&($file_ext!='.jpg')&&($file_ext!='.jpeg')&&($file_ext!='.gif')){
					...
					mysql_query("insert into preteach_tbl (tech_id, tech_name, tech_designation, tech_indxno, tech_contact, tech_sub, tech_photo) 
					values('$tech_id','$tech_name','$tech_designation','$tech_indxno','$tech_contact','$tech_sub','$f1')")or die(mysql_error());
