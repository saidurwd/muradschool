...
<body>
	<h2>Present Girls Student's Information</h2>
	<a style="float:right;color:aqua;font-size:15px;padding:10px;" href="index.php?action=_student_girls_add">Add New Data</a>
	<table border="1" id="mytable">
		...
		<tr>
			...
			<td>
				<a href="_student_girls_edit.php?id=<?php echo $row['s_id'];?>">Edit</a> | 
				<a onClick="return confirm_del();" href="_student_girls_del.php?id=<?php echo $row['s_id'];?>">Delete</a>
			</td>
		</tr>
		<?php } ?>
	</table>
