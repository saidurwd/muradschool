    ...
    if ($error > 0) {
        ...
        if ($size > 10000000) {
            ...
            if (($file_ext != '.png') && ($file_ext != '.jpg') && ($file_ext != '.jpeg') && ($file_ext != '.gif')) {
                ...
                mysql_query("insert into std_class8_tbl (std_id, std_roll, std_cls, std_name, std_father, std_mother, std_sft, std_sec, std_grp, std_dob, std_reli, std_gen, std_sub, std_photo, student_device_id) 
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <table id="std_class8_tbl">
                <tr>
                    ...
                    <td><input type="text" name="student_device_id" placeholder="i.e. 80001" required /></td>
                </tr>
                <tr>
                    <td>ID: </td>
