                            ...
                            <div class="post">
                                ...
                                if (isset($_POST['form1'])) {
                                    ...
                                    if (empty($_FILES["tech_photo"]["name"])) {
                                        ...
                                        mysql_query("update preteach_tbl set tech_id = '$_POST[tech_id]', tech_name = '$_POST[tech_name]', tech_designation = '$_POST[tech_designation]', tech_indxno = '$_POST[tech_indxno]', tech_contact = '$_POST[tech_contact]', tech_sub = '$_POST[tech_sub]', device_id = '$_POST[device_id]' where t_id = '$id'");
                                ...
                                <form action="" method="post"  enctype="multipart/form-data">
                                    ...
                                    <table>
                                        <tr>
                                            <td>Device ID: </td>
                                            <td><input type="text" name="device_id" value="<?php echo $device_id_past; ?>" required /></td>
                                        </tr>
                                        <tr>
                                            <td>Teacher ID: </td>
