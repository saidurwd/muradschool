                        ...
                        <div id="content">
                            <div class="post">
                                ...
                                if (isset($_POST['form1'])) {
                                    ...
                                    if (empty($_FILES["std_photo"]["name"])) {
                                        ...
                                        if (($file_ext != '.png') && ($file_ext != '.jpg') && ($file_ext != '.jpeg') && ($file_ext != '.gif')) {
                                            ...
                                            $result = mysql_query("SELECT * FROM std_class2_tbl WHERE s_id=$id");
                                            ...
                                            $sql = "update std_class2_tbl set std_id = '$_POST[std_id]', std_roll = '$_POST[std_roll]', std_cls = '$_POST[std_cls]', std_name = '$_POST[std_name]', std_father = '$_POST[std_father]', std_mother = '$_POST[std_mother]', std_sft = '$_POST[std_sft]', std_sec = '$_POST[std_sec]', std_grp = '$_POST[std_grp]', std_dob = '$_POST[std_dob]', std_reli = '$_POST[std_reli]', std_gen = '$_POST[std_gen]', std_sub = '$_POST[std_sub]', std_photo = '$f1', student_device_id = '$_POST[student_device_id]' where s_id = '$id'";
                                            $rs = mysql_query($sql);
                                ...
                                while ($row = mysql_fetch_array($result)) {
                                    ...
                                    $student_device_id_past = $row['student_device_id'];
                                }
                                ?>
                                <form action="" method="post"  enctype="multipart/form-data">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td><input type="text" name="student_device_id" value="<?php echo $student_device_id_past; ?>" required /></td>
                                        </tr>
                                        <tr>
                                            <td>ID: </td>
