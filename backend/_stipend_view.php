...
<body>
	<h2>View Notice</h2>
	<a style="float:right;color:aqua;font-size:15px;padding:10px;" href="index.php?action=_stipend_add">Add New Data</a>
	<table border="1" id="mytable">
		...
		<tr>
			...
			<td>
				<a href="_stipend_edit.php?id=<?php echo $row['n_id'];?>">Edit</a> | 
				<a onClick="return confirm_del();" href="_stipend_del.php?id=<?php echo $row['n_id'];?>">Delete</a>
			</td>
		</tr>
		<?php } ?>
	</table>
