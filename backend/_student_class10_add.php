		...
		if ($error > 0){
			...
			die("Format is not allowed or file size is too big!");
				...
				if(($file_ext!='.png')&&($file_ext!='.jpg')&&($file_ext!='.jpeg')&&($file_ext!='.gif')){
					...
					mysql_query("insert into std_class10_tbl (std_id, std_roll, std_cls, std_name, std_father, std_mother, std_sft, std_sec, std_grp, std_dob, std_reli, std_gen, std_sub, std_photo) 
					values('$std_id','$std_roll','$std_cls','$std_name','$std_father','$std_mother','$std_sft','$std_sec','$std_grp','$std_dob','$std_reli','$std_gen','$std_sub','$f1')")or die(mysql_error());
					
					echo"<p style='font-size:20px;'>Student Data input successfully</p>";
				}
			}
			//header("location: index.php?action=_stu_class10_view");
		}
	}
...
<body>
	<h2>Insert a present class 10 student details in here...</h2>
	
	<form action="" method="post" enctype="multipart/form-data">
		<table id="std_class10_tbl">
			<tr>
				<td>ID: </td>
