...
<body>
	<h2>Present Class 5 Student's Information</h2>
	<a style="float:right;color:aqua;font-size:15px;padding:10px;" href="index.php?action=_student_class5_add">Add New Data</a>
	<table border="1" id="mytable">
		...
		<?php
			$i = 0;				
			$result= mysql_query("select * from std_class5_tbl" ) or die (mysql_error());
		...
		<tr>
			...
			<td>
				<a href="_student_class5_edit.php?id=<?php echo $row['s_id'];?>">Edit</a> | 
				<a onClick="return confirm_del();" href="_student_class5_del.php?id=<?php echo $row['s_id'];?>">Delete</a>
			</td>
		</tr>
		<?php } ?>
	</table>
