...
<html lang="en-US">
    ...
    <body>
        ...
        $sql = "SELECT * FROM result_tbl LIMIT $start_from, $num_rec_per_page";
        $rs_result = mysql_query($sql);
        ?>
        <div class="resultview">
            <h2>View All Internal Result</h2>
            <a href="index.php?action=_int_result_add" style="color: #cfcfcf;float: right;font-size: 15px;font-weight: bold;margin-bottom: 10px;margin-right: 10px;">You can Add New result in here...</a>
        </div>
        <?php
        $i = 0;
        ...
        while ($row = mysql_fetch_array($rs_result)) {
            ...
            <table cellspacing="0" cellpadding="0" width="100%" border="1" style="margin-bottom: 15px; border: 3px solid red;border-collapse: collapse;">
                <tbody>
                    <tr>
                        <td valign="middle" height="30" align="center" style="font-weight: bold; font-size: 13px; color: aquamarine;"><?php echo $i; ?>. <?php echo $row['res_num']; ?>'s <?php echo $row['res_class']; ?> Result <?php echo $row['res_year']; ?><hr>
