...
<div align="center"> 
  ...
  <?php include("pdf/motionmenu.php"); ?>
    ...
    <table border="0" cellspacing="0" cellpadding="0" bgcolor="#ccCCCC">
 	...
 	$result=mysql_query("select * from difpageup where name='zeroposition'");
       while ($data=mysql_fetch_row($result))
	   			{
				echo"Name:<p align=\"justify\"> $data[1] </p>";
				echo"zero position Picture: <br><img src=\"pdf/zeroposition.jpg\">; </p>";
			echo"zero position Description:<p align=\"justify\"> $data[2] </p>";
			echo"zero position Note:<p align=\"justify\"> $data[3] </p>";
				}
